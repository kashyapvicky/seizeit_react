...
export default container = StyleSheet.create({
  ...
  searchView: {
    ...
    borderRadius: 20,
    height: 40,
    backgroundColor: "rgba(150,197,15,0.05)",
    marginHorizontal: 16
  },
  sliderOne: {
    flexDirection: "row",
  ...
  contactUsView: {
    paddingVertical: 15,
    borderBottomColor: "rgba(91,37,31,0.09)",
  ...
  orderAsServiceViewFlatFirstSection: {
    flex: 0.3,
    paddingLeft: 2,
    flexWrap: "wrap"
  },
  ...
  allCustomersFlatlistView: {
    flexDirection: "row",
    justifyContent: "space-between",
    marginBottom: 10
  },

  imageViewCheckUncheck: {
    flex: 0.1,
    justifyContent: "flex-end",
    alignItems: "flex-end"
  },
  ...
  InTransistView: {
    height: 1,
    marginHorizontal: 20,
    backgroundColor: "rgba(91,37,31,0.09)",
    marginTop: 10
  },
