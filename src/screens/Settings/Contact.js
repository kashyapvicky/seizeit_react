                ...
                <SafeAreaView
                    ...
                    <View style={styles.topOfProductDetail}>
                        ...
                        <ScrollView>
                            ...
                            <TouchableOpacity onPress={() => Communications.email([this.state.email, ''], null, null, '', '')}>
                            <View style={[styles.emailView,styles.shadow, { 
                                elevation:2,
                                shadowRadius:2,shadowOpacity:0.4,marginTop:50 }]}>
                                    <View style={{ flex: 0.2 }}>
                            ...
                            <TouchableOpacity onPress={() => Communications.phonecall(this.state.contact, true)}>
                            <View style={[styles.emailView,styles.shadow, { shadowRadius:2,shadowOpacity:0.4,elevation:2,
 }]}>
                                    <View style={{ flex: 0.2, }}>
                                        <View style={[styles.emailViewImage]}>
                                                <Image source={email} style={{alignSelf:'center'}}/>
