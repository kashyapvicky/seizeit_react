      ...
      return <View>
            <View style={{ marginBottom: 16 ,paddingHorizontal:8,
                ...
                paddingTop:16}}>
                    ...
                    <View style={{alignItems:'flex-start', marginBottom: 10 ,paddingHorizontal:8}}>
                        {/* <HTML html={item && item.description ? item.description : null} imagesMaxWidth={screenDimensions.width} /> */}

                        <Text style={styles.blog_desc}>{'— Admin'}</Text>
                    </View>
                    <View style={{ marginBottom: 15,paddingHorizontal:8 ,paddingBottom:8,alignItems:'flex-start',}}>
